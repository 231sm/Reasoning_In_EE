...
class DmcnnFormatter(object):
    ...
    def process(self, data, mode):
        ...
        for item in data:
            ...
            tokens.append(
                item["tokens"] + [Global.word2id["<PAD>"]] * (sequence_length - length))
